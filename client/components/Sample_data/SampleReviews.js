// Sample of 6 reviews for product 20111 from postman
// http://app-hrsei-api.herokuapp.com/api/fec2/hr-sea/reviews/?product_id=20111&sort=relevant&count=6
const reviewData = {
  product: '20111',
  page: 0,
  count: 6,
  results: [
    {
      review_id: 248280,
      rating: 1,
      summary: 'Soluta quisquam atque error error velit ad.',
      recommend: false,
      response: null,
      body: 'Sapiente repudiandae laudantium numquam dolor. Sit in sint sint quae harum amet. Magnam incidunt quaerat dolores dignissimos ipsum sed. Quas facilis nesciunt aut. Quod eligendi veritatis quam nisi quasi vel temporibus nesciunt quae.',
      date: '2021-01-06T00:00:00.000Z',
      reviewer_name: 'Fausto.Labadie',
      helpfulness: 29,
      photos: [
        {
          id: 457367,
    ...
    },
    {
      review_id: 248285,
      rating: 4,
      summary: 'Nihil voluptatem modi porro.',
      recommend: true,
      response: '"Rerum dolorum adipisci sunt nemo."',
      body: 'Sed distinctio qui voluptas ducimus. Molestias sint porro aliquid aut. Excepturi ut ducimus amet ratione vel ea. Rem dolorem sit.',
      date: '2020-10-18T00:00:00.000Z',
      reviewer_name: 'Nico50',
      helpfulness: 28,
      photos: [
        {
          id: 457354,
    ...
    },
    {
      review_id: 248283,
      rating: 4,
      summary: 'Repellat repellendus labore rem ipsa ut qui tenetur quis sed.',
      recommend: true,
      response: null,
      body: 'Unde sed atque molestiae laboriosam. Deserunt est pariatur sint officiis voluptate nobis est beatae. Inventore qui qui aliquid fugiat itaque laborum voluptatem. Molestias eos provident tempore sapiente.',
      date: '2020-08-31T00:00:00.000Z',
      reviewer_name: 'Britney.Crooks',
      helpfulness: 28,
      photos: [
        {
          id: 457359,
    ...
    },
    {
      review_id: 248284,
      rating: 3,
      summary: 'Ea enim similique quisquam magni laudantium qui saepe blanditiis.',
      recommend: true,
      response: null,
      body: 'Commodi similique aut fugiat consectetur eum. Distinctio aspernatur amet molestiae ipsam corrupti quis deserunt. Voluptatum mollitia quia voluptatem veritatis occaecati occaecati rerum architecto sapiente.',
      date: '2020-11-07T00:00:00.000Z',
      reviewer_name: 'Maude26',
      helpfulness: 10,
      photos: [
        {
          id: 457357,
    ...
    },
    {
      review_id: 248281,
      rating: 5,
      summary: 'Cum velit expedita nesciunt et.',
      recommend: true,
      response: null,
      body: 'Repellat voluptas sit sunt molestiae optio ullam molestiae omnis consequatur. Fugit explicabo est et veniam qui nulla. Velit sed et consequatur ut aliquam.',
      date: '2020-11-20T00:00:00.000Z',
      reviewer_name: 'Maximilian_Schneider',
      helpfulness: 6,
      photos: [
        {
          id: 457364,
    ...
    },
    {
      review_id: 248282,
      rating: 1,
      summary: 'Aperiam consequatur voluptate rerum voluptas consequatur fugiat commodi sequi ab.',
      recommend: false,
      response: null,
      body: 'Distinctio et distinctio repellendus. Magni quod ipsum maiores aspernatur porro quia aut dolorem quis. Excepturi unde reprehenderit sint dolorem quas et et nostrum. Sint nesciunt ut reiciendis ullam. Laboriosam distinctio autem nihil.',
      date: '2020-08-29T00:00:00.000Z',
      reviewer_name: 'Andreanne85',
      helpfulness: 3,
      photos: [
        {
          id: 457362,
